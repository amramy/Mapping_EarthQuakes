...
legend.onAdd = function() {
    ...
    for (var i = 0; i < magnitudes.length; i++) {
        ...
        // next line of code is complicated but creates the legend
        //  first argument[i] contantinates + (second argument ture = low end "- dash" high end : second argument false "first argument + sign"  )
        // style the legend in the css style file
